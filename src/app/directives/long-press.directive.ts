...
export class LongPressDirective implements OnInit, OnDestroy {
  ...
  private _hammer: HammerManager|any
  private int: number|any
  ...
  ngOnInit(): void {
    ...
    this._hammer = new Hammer.Manager(this.el, {
      //recognizers: [[Hammer.Pan, { direction: Hammer.DIRECTION_HORIZONTAL }], [Hammer.Press], [Hammer.Tap]],
