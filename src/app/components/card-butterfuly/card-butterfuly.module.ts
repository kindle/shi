...
import { CardButterfulyComponent } from './card-butterfuly.component';
...
@NgModule({
  ...
  declarations: [CardButterfulyComponent],
  schemas:[CUSTOM_ELEMENTS_SCHEMA],
  exports: [CardButterfulyComponent]
})
export class CardButterfulyComponentModule {}
