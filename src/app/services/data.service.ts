...
//console.log(item)
  ...
  star28Map:any = new Map([
    ["角",{image:"", short:"角木蛟", title:"星垂平野阔，月涌大江流", desc:"角宿是东方苍龙七宿之首，位于东方青龙的龙角位置，古人常以它作为春回大地、万象更新的重要天象标志。其名中的“木蛟”源于二十八宿配属体系，兼具方位、五行与神兽象征。"}],
    ["亢",{image:"", short:"亢金龙", title:"云母屏风烛影深，长河渐落晓星沉", desc:"亢宿位于角宿之后，在东方苍龙形象中象征龙颈。古人认为亢宿星势显扬，主高亢、刚健，也常被用来观测季节流转与夜空方位。"}],
    ["氐",{image:"", short:"氐土貉", title:"纤云弄巧，飞星传恨，银汉迢迢暗度", desc:"氐宿属于东方苍龙之宿，古人多将其视为龙胸或龙根所在。它在古代星占体系中与土地、根基、安定等意象相关，因此有“土貉”之称。"}],
    ["房",{image:"", short:"房日兔", title:"迟迟钟鼓初长夜，耿耿星河欲曙天", desc:"房宿位于东方苍龙中部，是二十八宿中较受重视的一宿，常被视为“天驷”相关星区之一。古人认为房宿象征居所与秩序，也与皇家礼制、车驾等意象相连。"}],
    ["心",{image:"", short:"心月狐", title:"东风夜放花千树，更吹落，星如雨", desc:"心宿居于东方苍龙中央，最著名的亮星即心宿二，是中国古代观星中极具代表性的红色亮星。心宿常被视为龙心，象征中枢、神采与灵动。"}],
    ["尾",{image:"", short:"尾火虎", title:"醉后不知天在水，满船清梦压星河", desc:"尾宿位于东方苍龙尾部，形象上对应龙尾。古人以其与心宿、箕宿相连来勾勒苍龙形态，在星占和分野体系里多带有武动、奋发之意。"}],
    ["箕",{image:"", short:"箕水豹", title:"七八个星天外，两三点雨山前", desc:"箕宿是东方苍龙七宿的末宿，形似簸箕，故得其名。古人常以箕宿关联风势、扬播与收敛，也把它看作东方星区的重要收束位置。"}],
    ["斗",{image:"", short:"斗木獬", title:"玉衡指孟冬，众星何历历", desc:"斗宿为北方玄武七宿之首，因星形如斗而得名。它在古代历法与天文观测中地位很高，常被用来辨识时令、方向，并与“南斗”信仰密切相关。"}],
    ["牛",{image:"", short:"牛金牛", title:"天阶夜色凉如水，卧看牵牛织女星", desc:"牛宿位于北方玄武星区，名称与“牛”有关，也常让人联想到牵牛星附近的天区。其星象在古代常被赋予勤作、农事与坚忍的象征意义。"}],
    ["女",{image:"", short:"女土蝠", title:"迢迢牵牛星，皎皎河汉女", desc:"女宿属于北方玄武七宿之一，古人常将其与织女、闺阁、巧艺等文化意象联系起来。它在星占传统中也常关联婚嫁、女性与文巧之事。"}],
    ["虚",{image:"", short:"虚日鼠", title:"危楼高百尺，手可摘星辰", desc:"虚宿位于北方玄武中段，名称有空虚、旷远之意。古代星占中常把虚宿与丧祭、肃穆、静定等象征联系起来，是文化意味较强的一宿。"}],
    ["危",{image:"", short:"危月燕", title:"草木摇杀气，星辰无光彩", desc:"危宿在北方玄武星区中位置较高，名字有高危、险峻之意。古人认为危宿与高台、危屋、戒慎等意象有关，观象时常被视作提醒谨慎的一宿。"}],
    ["室",{image:"", short:"室火猪", title:"明月皎皎照我床，星汉西流夜未央", desc:"室宿在北方玄武中象征宫室与房屋，古人视其为营造、安居的重要星宿。其含义与“室”字相通，因此多用于引申居所、家宅和秩序。"}],
    ["壁",{image:"", short:"壁水貐", title:"迢迢新秋夕，亭亭月将圆", desc:"壁宿与室宿相邻，共同构成与屋舍、墙壁相关的象征体系。古人认为壁宿主文章、藏书与屏障，带有守护、收纳和文教的意味。"}],
    ["奎",{image:"", short:"奎木狼", title:"锦城丝管日纷纷，半入江风半入云", desc:"奎宿为西方白虎七宿之首，古人常认为奎宿主文运，因此又有与文章、辞采相关的文化象征。其星区展开如腿，故在白虎形象中位置鲜明。"}],
    ["娄",{image:"", short:"娄金狗", title:"明星荧荧，开妆镜也", desc:"娄宿属于西方白虎星区，古代常与聚合、牵连、畜养等意象相联系。它在星官体系中位置承接奎宿，具有连接与过渡的特征。"}],
    ["胃",{image:"", short:"胃土雉", title:"露从今夜白，月是故乡明", desc:"胃宿位于西方白虎中段，其名与“胃仓”“积储”有关。古人常把它与仓廪、收藏、供养等意义联系起来，也用于农业和岁时观察。"}],
    ["昴",{image:"", short:"昴日鸡", title:"长安一片月，万户捣衣声", desc:"昴宿是中国古代最著名的星宿之一，对应一组较易辨认的聚星。它在民间和历法传统中知名度很高，常被视为节令转换与秋夜观星的重要标志。"}],
    ["毕",{image:"", short:"毕月乌", title:"毕竟西湖六月中，风光不与四时同", desc:"毕宿与昴宿相邻，在西方白虎形象中位置重要。古人认为毕宿有“毕网”之象，常与收束、完成、罗列及降雨意象相关。"}],
    ["觜",{image:"", short:"觜火猴", title:"鸟宿池边树，僧敲月下门", desc:"觜宿星数不多，却是白虎七宿中辨识度较强的一宿。其名中的“觜”有鸟嘴之意，在星象想象中常被看作白虎口部附近的星区。"}],
    ["参",{image:"", short:"参水猿", title:"人生不相见，动如参与商", desc:"参宿是冬季夜空中极醒目的星宿之一，亮星众多，形态鲜明。古人常以“参商不见”比喻分离，它在天文学与文学中都具有极高知名度。"}],
    ["井",{image:"", short:"井木犴", title:"明月出天山，苍茫云海间", desc:"井宿为南方朱雀七宿之首，因形似井栏而得名。古人常将井宿与水井、汲取、生养相关联，也视其为南方星区的重要起点。"}],
    ["鬼",{image:"", short:"鬼金羊", title:"吴楚东南坼，乾坤日夜浮", desc:"鬼宿名称独特，在古代星占中常与祭祀、精魂、敬慎之事相连。虽然名字带“鬼”，但更多体现的是古人对生死礼仪与幽明秩序的观念。"}],
    ["柳",{image:"", short:"柳土獐", title:"月落乌啼霜满天，江枫渔火对愁眠", desc:"柳宿位于南方朱雀星区，其名让人联想到柔条下垂的形态。古人认为柳宿兼具柔和与牵系之意，在分野与星占中有自身独特象征。"}],
    ["星",{image:"", short:"星日马", title:"星汉灿烂，若出其里", desc:"星宿之名直接称“星”，在二十八宿中十分特别。它位于南方朱雀中段，古人常借其表示光耀、显明与天象昭彰，因此辨识度很高。"}],
    ["张",{image:"", short:"张月鹿", title:"海上生明月，天涯共此时", desc:"张宿在南方朱雀形象中多被视作鸟翼舒张之处，故有伸展、开张之意。古代星占中也常把张宿与礼乐、宴享、张设等文化含义相联系。"}],
    ["翼",{image:"", short:"翼火蛇", title:"俱怀逸兴壮思飞，欲上青天览明月", desc:"翼宿顾名思义与羽翼相关，是南方朱雀七宿中极具形象感的一宿。古人将其视作飞扬、辅佐、展开之象，也常与乐舞、车舆等意象关联。"}],
    ["轸",{image:"", short:"轸水蚓", title:"郴江幸自绕郴山，为谁流下潇湘去", desc:"轸宿为南方朱雀七宿之末，常被看作车后横木或收尾之位。它在古代天文体系中具有总结、承载和转折的意义，也是南方星区的重要终点。"}],
  ]);
